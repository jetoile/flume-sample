...
public class CustomElasticSearchSerializerWithComma implements ElasticSearchEventSerializer {
    ...
    public XContentBuilder getContentBuilder(Event event) throws IOException {
        ...
        String[] headersToFill = body.split(";");
        ...
        try {
            ...
            ContentBuilderUtil.appendField(builder, "file", headersToFill[9].getBytes());

            ContentBuilderUtil.appendField(builder, "payload", headersToFill[10].getBytes());
